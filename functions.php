...
{
    // wp_enqueue_style('main-css', get_theme_file_uri('/css/bootstrap.css'));
    ...
    // wp_enqueue_script('custom-js', get_theme_file_uri('/build/scripts/custom.js'), array('jquery'), '1.0', true);
